...
if numCorreos == 0: 
    ...
    print("4. Leyendo la cabecera del primer mensaje...")

    # Solo procesamos el primer mensaje (i=1)
    i = 1
    ...
    try:
        ...
        if responseCompletoBytes.endswith(terminador):
            ...
            if pos == -1:
                ...
                print(f" -> Respuesta de estado: {statusString}")
        ...
        print("\nERROR: Timeout al leer el mensaje")
