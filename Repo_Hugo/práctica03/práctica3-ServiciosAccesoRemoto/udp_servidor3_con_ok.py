...
mensajeACK = "Ok" # mensaje de confirmación
    ...
    while True:
        try:
            ...
            if random.randint(0, 1) == 0:
                ...
                # Envia ACK de confirmación para el cliente
                servidor.sendto(mensajeACK.encode('utf-8'), direccionCliente)
                print(f"--- Enviado ACK a {direccionCliente}")
